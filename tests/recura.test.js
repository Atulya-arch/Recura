...
describe('Recura Core Business Logic & AI Tests', () => {
    ...
    describe('Hinglish Voice & Promise-to-Pay (PTP) NLP Engine', () => {
        ...
        it('should extract specific salary date commitment from Hinglish text', async () => {
            const extraction = await aiService.extractPromiseToPay('Bhaiya salary 7th ko aayegi, tab auto-retry kar lena', 'Rahul Sharma', 'ORD-100', '₹2,999', fixedBaseDate);
        ...
        it('should handle immediate payment intent', async () => {
            const extraction = await aiService.extractPromiseToPay('Main abhi pay karne ko ready hoon link bhej do', 'Rahul Sharma', 'ORD-100', '₹2,999', fixedBaseDate);
        ...
        it('should handle cancellation intent', async () => {
            const extraction = await aiService.extractPromiseToPay('Order cancel kar do mujhe nahi chahiye', 'Rahul Sharma', 'ORD-100', '₹2,999', fixedBaseDate);
