...
export class RecoveryEngine {
    ...
    async processTransaction(transactionId) {
        ...
        const currentPolicy = merchantPolicyRecord
            ? {
        ...
        const formattedTx = {
            ...
            paymentStatus: txRecord.paymentStatus,
            failureReason: txRecord.failureReason,
            paymentMethod: txRecord.paymentMethod,
            checkoutStatus: txRecord.checkoutStatus,
        ...
        const eligibility = PolicyEngine.isEligible(formattedTx, formattedCustomer, existingCase ? existingCase : null, currentPolicy);
        ...
        const policyResult = PolicyEngine.evaluateAiRecommendation({ recommendedAction: decision.recommendedAction, confidence: decision.confidence }, currentCaseRecord, existingActions, currentPolicy);
        ...
        const execution = await this.executor.executeApprovedAction(currentCaseRecord, chosenAction, existingActions, currentPolicy);
        // Save Action Record
